...
public class Jugador3  extends ObejtoJuego{
	private int vida;
	...
	public Jugador3(int x, int y, String nombreImagen, int velocidad, int vida, String animacionActual) {
	...
	public void inicializarAnimaciones() {
		Rectangle coordenadasCorrer[] ={
				new Rectangle(31,375,38,51),
				new Rectangle(84,375,38,51),
				new Rectangle(137,375,38,51),
				new Rectangle(189,375,38,51),
		...
		Rectangle coordenadasDescanso[] = {
			new Rectangle (34,433,34,47),
			new Rectangle (76,433,34,47),
			new Rectangle (119,433,34,47),
			new Rectangle (161,433,34,47)
	...
	public String toString() {
		return "Jugador3[x=" + x + ", y=" + y + ", vida=" + vida + ", nombreImagen=" + nombreImagen + ", velocidad="
				+ velocidad + "]";
	}
	...
	public void pintar(GraphicsContext graficos) {
		graficos.drawImage(Juego.imagenes.get(nombreImagen),xImagen,yImagen,anchoImagen,altoImagen, x+(anchoImagen*xP), y, direccion*anchoImagen/1.2, altoImagen/1.2);
