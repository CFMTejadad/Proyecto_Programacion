...
public class JugadorAnimado extends ObejtoJuego{
	private int vida;
	...
	public void inicializarAnimaciones() {
		Rectangle coordenadasCorrer[] ={
			new Rectangle(53,506,58,55),
			new Rectangle(118,506,58,59),
			new Rectangle(181,506,59,58),
			new Rectangle(245,506,58,58),
			new Rectangle(118,506,58,59),
			new Rectangle(53,506,58,55)
		...
		Rectangle coordenadasDescanso[] ={
				new Rectangle(686,191,42,55),
				new Rectangle(739,191,42,55),
				new Rectangle(787,191,42,55),
				new Rectangle(838,191,42,55),
	...
	//public void verificarColisionesItem(Item item) {
		//if (this.obtenerRectangulo().getBoundsInLocal().intersects(item.obtenerRectangulo().getBoundsInLocal()));
	     // System.out.print("Estan colisionando");
	//}
